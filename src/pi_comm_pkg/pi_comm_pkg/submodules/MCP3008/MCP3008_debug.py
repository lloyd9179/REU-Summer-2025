...
class MCP3008():
	...
	def __init__(self):
		...
		print("DEBUG: MCP3008 started in debug mode")
	...
	def read_analog_input(self, channel):
		...
		print("DEBUG: MCP3008 reading anaglog input channel {}".format(channel))
		return 0
	...
	def read_analog_input_diff(self, channel):
		...
		# ~ data = ((adc[1]&3) << 8) + adc[2]
		print("DEBUG: MCP3008 reading anaglog input diff channel {}".format(channel))
		return 0
